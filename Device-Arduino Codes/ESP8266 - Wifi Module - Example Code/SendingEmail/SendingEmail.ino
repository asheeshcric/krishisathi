...
#define EMAIL_FROM_BASE64 "YXNoaXoyMDEzQGdtYWlsLmNvbQ=="
#define EMAIL_PASSWORD_BASE64 "aWFtYXNoaXNo"

#define HOST     "smtp2go.com"     // Find/Google your email provider's SMTP outgoing server name for unencrypted email
